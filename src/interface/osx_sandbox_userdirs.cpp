...
void OSXSandboxUserdirsDialog::Run(wxWindow* parent, bool initial)
{
	...
	main->Add(new wxStaticText(this, -1, _("You need to grant TabFTP access to the directories you want to download files into or to upload files from.")));
	main->Add(new wxStaticText(this, -1, _("Please add the local directories you want to use TabFTP with.")));
