...
bool CWelcomeDialog::Run(bool force)
{
	...
	Create(parent_, -1, _("Welcome to TabFTP"));
	...
	auto heading = new wxStaticText(this, -1, _T("TabFTP ") + GetFileZillaVersion());
	...
	header->Add(CThemeProvider::Get()->createStaticBitmap(this, L"ART_TABFTP", iconSizeLarge));

	main->Add(new wxStaticLine(this), lay.grow);

wxString const url = _T("https://welcome.tabftp.org/welcome?type=client&category=%s&version=") + ownVersion;
	...
	main->Add(new wxHyperlinkCtrl(this, -1, _("Asking questions in the TabFTP Forums"), wxString::Format(url, _T("support_forum"))), 0, wxLEFT, lay.indent);
	...
	main->Add(new wxHyperlinkCtrl(this, -1, _("Configuring TabFTP and your network"), wxString::Format(url, _T("documentation_network"))), 0, wxLEFT, lay.indent);
