...
public:
	...
	uint8_t flags;
	bool is_dir() const { return flags & flag_dir; }
	bool is_link() const { return flags & flag_link; }
};
...
public:
	...
	void SetContextControl(CContextControl* pContextControl) { m_pContextControl = pContextControl; }
	CLocalPath GetDir() const { return m_dir; }
...
protected:
	...
	void OnMenuUpload(wxCommandEvent& event, CState* pState);
	...
	void OnMenuUploadToAll(wxCommandEvent& event);
