...
public:
	...
	void QueueProxyTransfer(const Site& sourceSite, const CServerPath& sourcePath, const std::wstring& fileName, const Site& targetSite, const CServerPath& targetPath);
