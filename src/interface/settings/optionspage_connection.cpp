...
bool COptionsPageConnection::CreateControls(wxWindow* parent)
{
...

	{
		...
		inner->Add(new wxStaticText(box, nullID, _("If no data is sent or received during an operation for longer than the specified time, the connection will be closed and TabFTP will try to reconnect.")));
	}
	{
