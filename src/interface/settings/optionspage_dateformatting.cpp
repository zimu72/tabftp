...
bool COptionsPageDateFormatting::CreateControls(wxWindow* parent)
{
	...
	auto link = new wxHyperlinkCtrl(this, nullID, _("Show details about custom date and time formats"), L"https://wiki.tabftp.org/Date_and_Time_formatting");
	link->SetToolTip(L"https://wiki.tabftp.org/Date_and_Time_formatting");
	main->Add(link);
