...
bool COptionsPageConnectionSFTP::CreateControls(wxWindow* parent)
{
...

	{
		...
		inner->Add(new wxStaticText(box, nullID, _("To support public key authentication, TabFTP needs to know the private keys to use.")));
...
#ifdef __WXMSW__
		inner->Add(new wxStaticText(box, nullID, _("Alternatively you can use the Pageant tool from PuTTY to manage your keys, TabFTP does recognize Pageant.")));
#else
