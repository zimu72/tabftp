...
int CUpdateDialog::ShowModal()
{
...

	{
		...
		s->Add(new wxStaticText(p, -1, _("Information about the latest version of TabFTP could not be retrieved. Please try again later.")));
		...
		s->Add(new wxStaticText(p, XRCID("ID_WEBSITE_TEXT"), _("You can download the latest version from the TabFTP website:")));
		s->Add(new wxHyperlinkCtrl(p, XRCID("ID_WEBSITE_LINK"), L"https://github.com/zimu72/tabftp", L"https://github.com/zimu72/tabftp"));
...

	{
		...
		s->AddGrowableRow(4);
		s->AddGrowableCol(0);
		s->Add(new wxStaticText(p, -1, _("A new version of TabFTP is available:")));
		...
		s->Add(new wxStaticText(p, XRCID("ID_NEWVERSION_WEBSITE_TEXT_DLFAIL"), _("Alternatively, you can also download the latest version from the TabFTP website:")));
		s->Add(new wxStaticText(p, XRCID("ID_NEWVERSION_WEBSITE_TEXT"), _("You can download the latest version from the TabFTP website:")));
		s->Add(new wxHyperlinkCtrl(p, XRCID("ID_NEWVERSION_WEBSITE_LINK"), L"https://github.com/zimu72/tabftp", L"https://github.com/zimu72/tabftp"));
	}

	{
		...
		s->AddStretchSpacer();
		s->Add(new wxStaticText(p, -1, _("You are using the latest version of TabFTP."), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE_HORIZONTAL), lay.grow);
		s->AddStretchSpacer();
	}
