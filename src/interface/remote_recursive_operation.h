...
public:
	...
	void SetProxyTarget(Site const& site, CServerPath const& targetBase, std::wstring const& dummyLocalRoot = std::wstring());
...
protected:
	...
	void handle_listing_failed() override;
	...
	Site m_proxyTargetSite;
	CServerPath m_proxyTargetBase;
	std::wstring m_dummyLocalRoot;
