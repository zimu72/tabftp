...
wxColour const background_colors[] = {
	wxColour(),
	wxColour(239, 83, 80, 48), // Red
	wxColour(102, 187, 106, 48), // Green
	wxColour(66, 165, 245, 48), // Blue
	wxColour(255, 238, 88, 48), // Yellow
	wxColour(38, 198, 218, 48), // Cyan
	wxColour(171, 71, 188, 48), // Magenta
	wxColour(255, 167, 38, 48) }; // Orange
}
