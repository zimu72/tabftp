...
bool CAskSavePasswordDialog::Create(wxWindow*)
{
	...
	main->Add(new wxStaticText(this, nullID, _("Would you like TabFTP to remember passwords?")));

	main->Add(new wxStaticText(this, nullID, _("When allowing TabFTP to remember passwords, you can reconnect without having to re-enter the password after restarting TabFTP.")));
